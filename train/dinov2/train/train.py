...
from dinov2.data import (
    ...
    DataAugmentationAlbumentations,
    MaskingGenerator,
    SamplerType,
...
def get_args_parser(add_help: bool = True):
    ...
    parser.add_argument(
        "--load-pretained",
        action="store_true",
        help="Whether to load the pretrained model from the official DINOv2 checkpoint.",
    )
...
def do_train(cfg, model, resume=False):
    ...
    elif cfg.data_transform == "albumentations":
        data_transform = DataAugmentationAlbumentations(
            cfg.aug,
            cfg.crops.global_crops_scale,
            cfg.crops.local_crops_scale,
            cfg.crops.local_crops_number,
...
def main(args):
    ...
    model = SSLMetaArch(cfg,args.load_pretained).to(torch.device("cuda"))
...
if __name__ == "__main__":
    ...
    wandb.init(project="dino_rbc_train", name=name, mode="online", config=args)
    main(args)
